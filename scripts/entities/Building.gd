...
func _create_visual():
	...
	if owner_peer_id == 1:       # 玩家
		color = Color(0.2, 0.6, 1.0)   # 亮蓝
	elif owner_peer_id == 2:     # AI队友
		color = Color(0.4, 0.8, 1.0)   # 浅蓝
	elif owner_peer_id == 3:     # 红方AI1
		color = Color(1.0, 0.3, 0.2)   # 深红
	elif owner_peer_id == 4:     # 红方AI2
		color = Color(1.0, 0.6, 0.4)   # 橙红
